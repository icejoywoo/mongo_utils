...
env.Append(LIBS=['pthread', 'gtest', 'gtest_main', 'mongoclient', 'glog', 'gflags',
                 'boost_thread-mt', 'boost_system', 'boost_regex'])
env.Append(LIBPATH=['third_party/gtest/lib', 'third_party/gmock/lib', 'third_party/glog/lib', 'third_party/gflags/lib',
                    'third_party/boost/lib', 'third_party/mongo-cxx/lib'])
env.Append(CPPPATH=['third_party/gtest/include', 'third_party/gmock/include', 'third_party/glog/include', 'third_party/gflags/include',
